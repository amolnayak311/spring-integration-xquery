...
import org.springframework.integration.xquery.XQueryExecutor.BooleanResultMapper;
import org.springframework.integration.xquery.XQueryExecutor.NodeResultMapper;
import org.springframework.integration.xquery.XQueryExecutor.NumberResultMapper;
import org.springframework.integration.xquery.XQueryExecutor.StringResultMapper;
import org.w3c.dom.Node;

/**
 * The test class for the XQueryExecutor
 * @author Amol Nayak
 *
 */
public class XQueryExecutorTests {
	...
	public void initializeDefaultMappers() {
		XQueryExecutor executor = getDefaultExecutor();
	...
	public void executeForUnknownClassType() {
		...
		try {
			...
			Assert.assertEquals("No Result mapper found for the type org.springframework.integration.xquery.XQueryExecutorTests$MyCustomClass",
					e.getMessage());
		}
	}
	 ...
	 * @return
	 */
	private XQueryExecutor getDefaultExecutor() {
		XQueryExecutor executor = new XQueryExecutor();
